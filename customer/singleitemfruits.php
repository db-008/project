...
if (isset($_POST["btn_insert"])) {
    if (!isset($_SESSION['username'])) {
        ...
        $iid = $_GET['id'];
        $q = "select * from fruits where f_id=" . $iid;
        $info1 = $dao->query($q);
        $iname = $info1[0]["f_name"];
        $price = $info1[0]["f_price"];
        ...
        if ($quantity <= $currentStock) {
            ...
            $updateStockQuery = "UPDATE fruits SET stocks = $newStock WHERE f_id = $iid";
...
<form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-5 col-md-6">
                            <img class="img" style="width: 400; height: 400" src="<?php echo BASE_URL."img/".$info[0]["fimage"]; ?>" alt=" " class="img-responsive" />
                        </div>

                        <div class="col-xl-7 col-lg-7 col-md-6">
                            <div class="single-product-details">
                                <h2 style="margin-top: 8px;"><?php echo $info[0]["fname"];?></h2>
                                <h5 style="margin-top: 8px;"><?php echo '₹' .  $info[0]["fprice"];?></h5>
    ...
    <script>
      function showtotal() 
      {
        var price = <?php echo $info[0]["fprice"]; ?>;
