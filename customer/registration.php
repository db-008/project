...
$labels=array('name'=>"Name","username"=>"Username",'phone'=>"Phone",'email'=>"Email","password"=>"Password");
    ...
    <div class="main">
        ...
        <section class="signup">
			...
			<?php echo $validator->error('username') ?>
                            ...
                            <div class="form-group">
                               <!-- <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="name" id="name" placeholder="Your Name"/>--><h5>PHONE:<?php echo $form->textBox('phone'); ?> </h5>
			<?php echo $validator->error('phone') ?>
                            </div>
                            <div class="form-group">
                               <!-- <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="name" id="name" placeholder="Your Name"/>--><h5>EMAIL:<?php echo $form->textBox('email'); ?> </h5>
...
<form method="POST">
            ...
            <tr>
			<td><h4>PHONE:<?php echo $form->textBox('phone'); ?> </h4><br/></td>
			<td><?php echo $validator->error('phone') ?></td>
			</tr>
            <tr>
			<td><h4>EMAIL:<?php echo $form->textBox('email'); ?> </h4><br/></td>
