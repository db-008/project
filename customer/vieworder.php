...
<?php
    ...
    $actions=array(
        ...
        'delete'=>array('label'=>'Cancel Item','link'=>'cancel.php','params'=>array('id'=>'bid'),'attributes'=>array('class'=>'btn btn-success'))
    );
...
<button class="btn btn-success" type="submit" style="margin-right: 2px;"  name="book" ><a href="home.php">Back to Home</button>
