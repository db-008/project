...
$labels=array('name'=>"Name","username"=>"Username","password"=>"Password","email"=>"email","phone"=>"phonenumber");
        ...
        <section class="signup">
			...
			<?php echo $validator->error('username') ?>
                            ...
                            <div class="form-group">
                               <!-- <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="pass" id="pass" placeholder="Password"/>--><h5>EMAIL:<?php echo $form->textBox ('email'); ?></h4>
			<?php echo $validator->error('email') ?>
                            </div>
                            <div class="form-group">
                               <!-- <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="pass" id="pass" placeholder="Password"/>--><h5>PHONENUMBER:<?php echo $form->textBox ('phone'); ?></h4>
			...
			<?php echo $validator->error('password') ?>
                    ...
                    <div class="signup-image">
                        <figure><img src="registration/images/signup-imag.jpg" alt="sing up image"></figure>
