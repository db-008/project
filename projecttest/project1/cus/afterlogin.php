    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <!- <a class="navbar-brand" href="seller.php"><img src="images/logo.png" class="logo" alt=""></a> 
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="seller.php">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="viewbooking.php">Whishlist</a></li>
                        <li class="nav-item"><a class="nav-link" href="deliverpending.php">Delivery report</a></li>
                        <!-- <li class="nav-item"><a class="nav-link" href="reportcancel.php">Cancel report</a></li> -->
                        <li class="nav-item"><a class="nav-link" href="bookpending.php">Booking Pendings</a></li>
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        ...
                        <li class="total">
                            <a href="viewbooking" class="btn btn-default hvr-hover btn-cart">VIEW CART</a>
